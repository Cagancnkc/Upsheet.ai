const TRANSLATIONS = {
  tr: {
    ...
    'steps.title': 'Kataloğunuzdan sonuca.<br>Üç adımda.',
    'steps.sub': 'Shopify\'a bağla, AI analiz etsin, önerileri onayla — Mocksheets senkronize eder.',
    'steps.1.label': '01 · BAĞLA',
    'steps.1.title': 'Shopify mağazanı<br>tek tıkla bağla.',
    'steps.1.desc': 'OAuth ile güvenli bağlantı. Ürünler, varyantlar ve SEO alanları anında Mocksheets\'e gelir.',
    'steps.2.label': '02 · ANALİZ ET',
    'steps.2.title': 'AI kataloğunun<br>sağlığını ölçer.',
    'steps.2.desc': 'Eksik SEO, zayıf başlık, kısa açıklama — her ürün için sorun listesi ve öneri üretir.',
    'steps.3.label': '03 · ONAYLA & SENKRONİZE',
    'steps.3.title': 'Önerileri onayla,<br>Shopify\'a yazsın.',
    'steps.3.desc': 'Her değişiklik senin onayınla. Toplu kabul, tekli reddet — canlı mağaza yalnızca sen onayladığında değişir.',
