...
const EXCEL_DATASET = [
  ...
  // ──────────────────────────────────────────────────────────
  { user_command: "brüt kâr oranı sütunu ekle", logic: "Add a new column calculating gross profit margin as (revenue - cost) / revenue * 100", category: "muhasebe", output: {"action":"update_cells","formula":"=(Gelir-Maliyet)/Gelir*100","reply":"✅ Brüt kâr oranı sütunu hesaplanarak eklendi.","changes":[]} },
  { user_command: "depo transfer tarihi bu haftaki kayıtları göster", logic: "Filter rows where warehouse transfer date falls within the current week", category: "depo", output: {"action":"filter","condition":"this_week","column":"Depo Transfer Tarihi","value":"bu hafta","reply":"✅ Bu haftaki depo transfer kayıtları filtrelendi.","changes":[]} },
  { user_command: "tedarikçi ödeme vadesi en yakın olandan sırala", logic: "Sort supplier payment due date column in ascending order to show nearest deadlines first", category: "tedarik", output: {"action":"sort","direction":"asc","column":"Tedarikçi Ödeme Vadesi","reply":"✅ Tedarikçi ödeme vadesi en yakından en uzağa sıralandı.","changes":[]} },
  { user_command: "e-fatura iptal olanların sayısını bul", logic: "Count rows where e-invoice status equals cancelled", category: "e-fatura", output: {"action":"count","column":"E-Fatura Durumu","reply":"✅ İptal edilmiş e-fatura sayısı hesaplandı.","changes":[]} },
  { user_command: "sgk matrahı sıfır olan satırları sil", logic: "Delete rows where SGK base amount equals zero", category: "bordro", output: {"action":"delete_rows","condition":"SGK Matrahı = 0","reply":"🗑️ SGK matrahı sıfır olan satırlar silindi.","changes":[]} },
  { user_command: "fatura tutarı en büyükten küçüğe sırala", logic: "Sort invoice amount column in descending order", category: "muhasebe", output: {"action":"sort","direction":"desc","column":"Fatura Tutarı","reply":"✅ Fatura tutarı en büyükten küçüğe sıralandı.","changes":[]} },
  { user_command: "stok giriş miktarının toplamını hesapla", logic: "Calculate the sum of the stock entry quantity column", category: "stok", output: {"action":"sum","column":"Stok Giriş Miktarı","reply":"✅ Stok giriş miktarlarının toplamı hesaplandı.","changes":[]} },
  { user_command: "kdv oranı %20 olan faturaları vurgula", logic: "Highlight rows where KDV rate equals 20% with a distinct color", category: "muhasebe", output: {"action":"highlight","condition":"KDV Oranı = %20","color":"#FFD700","reply":"✅ KDV oranı %20 olan faturalar sarı ile vurgulandı.","changes":[]} },
  { user_command: "çalışan kıdem yılı sütununun ortalamasını bul", logic: "Calculate the average value of the employee seniority years column", category: "bordro", output: {"action":"average","column":"Kıdem Yılı","reply":"✅ Çalışan kıdem yılı ortalaması hesaplandı.","changes":[]} },
  { user_command: "sipariş durumu teslim edildi olanları filtrele", logic: "Filter rows where order status equals delivered", category: "satış", output: {"action":"filter","condition":"equals","column":"Sipariş Durumu","value":"Teslim Edildi","reply":"✅ Teslim edilmiş siparişler filtrelendi.","changes":[]} },
  { user_command: "depo çıkış miktarı en yüksek ürünü göster", logic: "Find and display the product with the maximum warehouse exit quantity", category: "depo", output: {"action":"max","column":"Depo Çıkış Miktarı","reply":"✅ Depo çıkış miktarı en yüksek ürün gösterildi.","changes":[]} },
  { user_command: "müşteri vergi numarası boş olanları sarıya boya", logic: "Highlight rows where customer tax number field is empty with yellow color", category: "muhasebe", output: {"action":"highlight","condition":"empty","color":"#FFFF00","reply":"✅ Vergi numarası boş olan müşteriler sarıya boyandı.","changes":[]} },
  { user_command: "aylık net maaş toplamını hesapla", logic: "Calculate the total sum of monthly net salary column", category: "bordro", output: {"action":"sum","column":"Net Maaş","reply":"✅ Aylık net maaş toplamı hesaplandı.","changes":[]} },
  { user_command: "tedarikçi kodu büyük harfe çevir", logic: "Transform supplier code column values to uppercase", category: "tedarik", output: {"action":"transform","transform":"uppercase","reply":"✅ Tedarikçi kodları büyük harfe çevrildi.","changes":[]} },
  { user_command: "stok rezervasyon miktarı en küçük ürünü bul", logic: "Find the product with the minimum reserved stock quantity", category: "stok", output: {"action":"min","column":"Stok Rezervasyon Miktarı","reply":"✅ Stok rezervasyon miktarı en küçük ürün bulundu.","changes":[]} },
  { user_command: "e-fatura gönderim tarihi en yeniden en eskiye sırala", logic: "Sort e-invoice send date column in descending order", category: "e-fatura", output: {"action":"sort","direction":"desc","column":"E-Fatura Gönderim Tarihi","reply":"✅ E-fatura gönderim tarihi en yeniden en eskiye sıralandı.","changes":[]} },
  { user_command: "negatif kâr marjı olan satırları kırmızıya boya", logic: "Highlight rows where profit margin value is negative with red color", category: "muhasebe", output: {"action":"highlight","condition":"< 0","color":"#FF0000","reply":"✅ Negatif kâr marjı olan satırlar kırmızıya boyandı.","changes":[]} },
  { user_command: "yeni bir tedarikçi kaydı ekle", logic: "Add a new empty row to the supplier records table", category: "tedarik", output: {"action":"add_row","reply":"➕ Yeni bir tedarikçi satırı eklendi.","changes":[]} },
  { user_command: "işçi sgk prim tutarı ortalamasını hesapla", logic: "Calculate the average worker SGK premium amount", category: "bordro", output: {"action":"average","column":"İşçi SGK Prim Tutarı","reply":"✅ İşçi SGK prim tutarı ortalaması hesaplandı.","changes":[]} },
  { user_command: "ödeme yöntemi eft olanları filtrele", logic: "Filter rows where payment method equals EFT", category: "muhasebe", output: {"action":"filter","condition":"equals","column":"Ödeme Yöntemi","value":"EFT","reply":"✅ Ödeme yöntemi EFT olan kayıtlar filtrelendi.","changes":[]} },
  { user_command: "depo lokasyon kodu boş olanları vurgula", logic: "Highlight rows where warehouse location code is empty", category: "depo", output: {"action":"highlight","condition":"empty","color":"#FFA500","reply":"✅ Depo lokasyon kodu boş olan satırlar turuncu ile vurgulandı.","changes":[]} },
  { user_command: "satış kanalı e-ticaret olanların toplam cirosunu hesapla", logic: "Calculate total revenue for rows where sales channel equals e-commerce", category: "satış", output: {"action":"sum","column":"Ciro","reply":"✅ E-ticaret kanalı toplam cirosu hesaplandı.","changes":[]} },
  { user_command: "tekrarlanan tedarikçi vergi numaralarını temizle", logic: "Remove duplicate rows based on supplier tax number column", category: "tedarik", output: {"action":"remove_duplicates","reply":"✅ Tekrarlanan tedarikçi vergi numaraları temizlendi.","changes":[]} },
  { user_command: "kdv matrahı boş olan faturaları filtrele", logic: "Filter rows where VAT base amount is empty or null", category: "e-fatura", output: {"action":"filter","condition":"empty","column":"KDV Matrahı","value":"boş","reply":"✅ KDV matrahı boş olan faturalar filtrelendi.","changes":[]} },
  { user_command: "çalışan unvanı sütununu baş harfleri büyük yap", logic: "Transform employee title column to title case with first letter capitalized", category: "bordro", output: {"action":"transform","transform":"titlecase","reply":"✅ Çalışan unvan sütununun baş harfleri büyütüldü.","changes":[]} },
  { user_command: "en yüksek stopaj vergisi tutarını göster", logic: "Find the maximum withholding tax amount in the column", category: "muhasebe", output: {"action":"max","column":"Stopaj Vergisi","reply":"✅ En yüksek stopaj vergisi tutarı gösterildi.","changes":[]} },
  { user_command: "stok sayım tarihi geçmiş olanları kırmızıya boya", logic: "Highlight rows where stock counting date is in the past compared to today", category: "stok", output: {"action":"highlight","condition":"< today","color":"#FF0000","reply":"✅ Stok sayım tarihi geçmiş olan satırlar kırmızıya boyandı.","changes":[]} },
  { user_command: "yeni bir e-arşiv fatura satırı ekle", logic: "Add a new empty row for e-archive invoice records", category: "e-fatura", output: {"action":"add_row","reply":"➕ Yeni bir e-arşiv fatura satırı eklendi.","changes":[]} },
  { user_command: "gelir vergisi stopaj toplamını hesapla", logic: "Calculate the total sum of income tax withholding column", category: "bordro", output: {"action":"sum","column":"Gelir Vergisi Stopajı","reply":"✅ Gelir vergisi stopaj toplamı hesaplandı.","changes":[]} },
  { user_command: "sipariş onay tarihi sütununu artan sıraya koy", logic: "Sort order approval date column in ascending order", category: "satış", output: {"action":"sort","direction":"asc","column":"Sipariş Onay Tarihi","reply":"✅ Sipariş onay tarihi artan sıraya konuldu.","changes":[]} },
  { user_command: "depo bölgesi iç anadolu olanları filtrele", logic: "Filter rows where warehouse region equals Inner Anatolia", category: "depo", output: {"action":"filter","condition":"equals","column":"Depo Bölgesi","value":"İç Anadolu","reply":"✅ Depo bölgesi İç Anadolu olan kayıtlar filtrelendi.","changes":[]} },
  { user_command: "birim maliyet sütununun ortalamasını hesapla", logic: "Calculate the average value of the unit cost column", category: "muhasebe", output: {"action":"average","column":"Birim Maliyet","reply":"✅ Birim maliyet ortalaması hesaplandı.","changes":[]} },
  { user_command: "tedarikçi teslim süresi en uzun olanı bul", logic: "Find the supplier with the maximum delivery duration", category: "tedarik", output: {"action":"max","column":"Tedarikçi Teslim Süresi","reply":"✅ Tedarikçi teslim süresi en uzun kayıt bulundu.","changes":[]} },
  { user_command: "fatura seri numarası tekrarlananları sil", logic: "Remove duplicate rows based on invoice serial number column", category: "e-fatura", output: {"action":"remove_duplicates","reply":"✅ Tekrarlanan fatura seri numaraları silindi.","changes":[]} },
  { user_command: "çalışma saati 50 üzeri olanları turuncu yap", logic: "Highlight rows where working hours exceed 50 with orange color", category: "bordro", output: {"action":"highlight","condition":"> 50","color":"#FFA500","reply":"✅ Çalışma saati 50'nin üzerindeki satırlar turuncu yapıldı.","changes":[]} },
  { user_command: "stok minimum seviye sütunu ekle", logic: "Add a new column for minimum stock level threshold values", category: "stok", output: {"action":"update_cells","formula":"Minimum Stok Seviyesi sütunu eklendi","reply":"✅ Stok minimum seviye sütunu eklendi.","changes":[]} },
  { user_command: "satış bölgesi iç anadolu olanların toplamını hesapla", logic: "Calculate total sales for rows where sales region equals Inner Anatolia", category: "satış", output: {"action":"sum","column":"Satış Tutarı","reply":"✅ İç Anadolu bölgesinin toplam satışı hesaplandı.","changes":[]} },
  { user_command: "kdv dahil tutar sütununu büyükten küçüğe sırala", logic: "Sort KDV included amount column in descending order", category: "muhasebe", output: {"action":"sort","direction":"desc","column":"KDV Dahil Tutar","reply":"✅ KDV dahil tutar sütunu büyükten küçüğe sıralandı.","changes":[]} },
  { user_command: "depo giriş fişi tarihi bu ay olanları filtrele", logic: "Filter rows where warehouse entry document date falls within the current month", category: "depo", output: {"action":"filter","condition":"this_month","column":"Depo Giriş Fişi Tarihi","value":"bu ay","reply":"✅ Bu ayki depo giriş fişleri filtrelendi.","changes":[]} },
  { user_command: "yeni bir sgk bildirge satırı ekle", logic: "Add a new empty row for SGK declaration records", category: "bordro", output: {"action":"add_row","reply":"➕ Yeni bir SGK bildirge satırı eklendi.","changes":[]} },
  { user_command: "e-fatura uuid boş olanları sarıya boya", logic: "Highlight rows where e-invoice UUID field is empty with yellow color", category: "e-fatura", output: {"action":"highlight","condition":"empty","color":"#FFFF00","reply":"✅ E-fatura UUID boş olan satırlar sarıya boyandı.","changes":[]} },
  { user_command: "toplam damga vergisi tutarını hesapla", logic: "Calculate the sum of all stamp duty tax amounts in the column", category: "muhasebe", output: {"action":"sum","column":"Damga Vergisi","reply":"✅ Toplam damga vergisi tutarı hesaplandı.","changes":[]} },
  { user_command: "stok devir hızı en düşük ürünü bul", logic: "Find the product with the minimum inventory turnover rate", category: "stok", output: {"action":"min","column":"Stok Devir Hızı","reply":"✅ Stok devir hızı en düşük ürün bulundu.","changes":[]} },
  { user_command: "tedarikçi ülkesi japonya olanları filtrele", logic: "Filter rows where supplier country equals Japan", category: "tedarik", output: {"action":"filter","condition":"equals","column":"Tedarikçi Ülkesi","value":"Japonya","reply":"✅ Tedarikçi ülkesi Japonya olan kayıtlar filtrelendi.","changes":[]} },
  { user_command: "borç bakiyesi sütununun toplamını hesapla", logic: "Calculate the total sum of the debt balance column", category: "muhasebe", output: {"action":"sum","column":"Borç Bakiyesi","reply":"✅ Toplam borç bakiyesi hesaplandı.","changes":[]} },
  { user_command: "çalışan pozisyonu uzman olanları maviye boya", logic: "Highlight rows where employee position equals specialist with blue color", category: "bordro", output: {"action":"highlight","condition":"equals Uzman","color":"#0000FF","reply":"✅ Pozisyonu uzman olan çalışanlar maviye boyandı.","changes":[]} },
  { user_command: "sipariş miktarı ortalamasını hesapla", logic: "Calculate the average order quantity across all rows", category: "satış", output: {"action":"average","column":"Sipariş Miktarı","reply":"✅ Sipariş miktarı ortalaması hesaplandı.","changes":[]} },
  { user_command: "depo raf kodu sütununu küçük harfe çevir", logic: "Transform warehouse shelf code column values to lowercase", category: "depo", output: {"action":"transform","transform":"lowercase","reply":"✅ Depo raf kodları küçük harfe çevrildi.","changes":[]} },
  { user_command: "yeni bir kur farkı geliri satırı ekle", logic: "Add a new empty row for foreign exchange gain records", category: "muhasebe", output: {"action":"add_row","reply":"➕ Yeni bir kur farkı geliri satırı eklendi.","changes":[]} },
  { user_command: "fatura ödeme tarihi geçmiş olanları filtrele", logic: "Filter rows where invoice payment date is earlier than today", category: "e-fatura", output: {"action":"filter","condition":"< today","column":"Fatura Ödeme Tarihi","value":"geçmiş","reply":"✅ Ödeme tarihi geçmiş faturalar filtrelendi.","changes":[]} },
  { user_command: "işveren sgk prim toplamını hesapla", logic: "Calculate the total employer SGK premium amount", category: "bordro", output: {"action":"sum","column":"İşveren SGK Primi","reply":"✅ İşveren SGK prim toplamı hesaplandı.","changes":[]} },
  { user_command: "stok çıkış miktarı sıfır olanları sil", logic: "Delete rows where stock exit quantity equals zero", category: "stok", output: {"action":"delete_rows","condition":"Stok Çıkış Miktarı = 0","reply":"🗑️ Stok çıkış miktarı sıfır olan satırlar silindi.","changes":[]} },
  { user_command: "nakit akışı negatif olanları kırmızıyla işaretle", logic: "Highlight rows where cash flow value is negative with red color", category: "muhasebe", output: {"action":"highlight","condition":"< 0","color":"#FF0000","reply":"✅ Nakit akışı negatif olan satırlar kırmızıyla işaretlendi.","changes":[]} },
  { user_command: "tedarikçi adreslerini büyük harfe çevir", logic: "Transform supplier address column values to uppercase", category: "tedarik", output: {"action":"transform","transform":"uppercase","reply":"✅ Tedarikçi adresleri büyük harfe çevrildi.","changes":[]} },
  { user_command: "e-fatura senaryosu ticari fatura olanları filtrele", logic: "Filter rows where e-invoice scenario equals commercial invoice", category: "e-fatura", output: {"action":"filter","condition":"equals","column":"E-Fatura Senaryosu","value":"Ticari Fatura","reply":"✅ E-fatura senaryosu ticari fatura olan kayıtlar filtrelendi.","changes":[]} },
  { user_command: "kıdem tazminatı tavanını aşan satırları vurgula", logic: "Highlight rows where severance pay exceeds the legal ceiling amount", category: "bordro", output: {"action":"highlight","condition":"> tavan","color":"#FF6600","reply":"✅ Kıdem tazminatı tavanını aşan satırlar vurgulandı.","changes":[]} },
  { user_command: "depo sayım noksanlığı toplamını hesapla", logic: "Calculate the total sum of inventory count shortage column", category: "depo", output: {"action":"sum","column":"Depo Sayım Noksanlığı","reply":"✅ Depo sayım noksanlığı toplamı hesaplandı.","changes":[]} },
  { user_command: "satış hedefi gerçekleşme oranı en düşük bölgeyi göster", logic: "Find the region with the minimum sales target achievement rate", category: "satış", output: {"action":"min","column":"Satış Hedefi Gerçekleşme Oranı","reply":"✅ Satış hedefi gerçekleşme oranı en düşük bölge gösterildi.","changes":[]} },
  { user_command: "yeni bir masraf beyanı satırı ekle", logic: "Add a new empty row for expense declaration records", category: "muhasebe", output: {"action":"add_row","reply":"➕ Yeni bir masraf beyanı satırı eklendi.","changes":[]} },
  { user_command: "kdv oranı %18 olan ürünlerin ortalama fiyatını göster", logic: "Calculate the average price for products where VAT rate equals 18%", category: "muhasebe", output: {"action":"average","column":"Fiyat","reply":"✅ KDV oranı %18 olan ürünlerin ortalama fiyatı hesaplandı.","changes":[]} },
  { user_command: "stok rezervasyon sütununu küçükten büyüğe sırala", logic: "Sort stock reservation column in ascending order", category: "stok", output: {"action":"sort","direction":"asc","column":"Stok Rezervasyonu","reply":"✅ Stok rezervasyon sütunu küçükten büyüğe sıralandı.","changes":[]} },
  { user_command: "tedarikçi sözleşme tarihi geçmiş olanları turuncu yap", logic: "Highlight rows where supplier contract date has passed with orange color", category: "tedarik", output: {"action":"highlight","condition":"< today","color":"#FFA500","reply":"✅ Sözleşme tarihi geçmiş tedarikçiler turuncu yapıldı.","changes":[]} },
  { user_command: "e-fatura gönderilmeyi bekleyenlerin sayısını say", logic: "Count rows where e-invoice status is pending send", category: "e-fatura", output: {"action":"count","column":"E-Fatura Durumu","reply":"✅ Gönderim bekleyen e-fatura sayısı hesaplandı.","changes":[]} },
  { user_command: "çalışan doğum yılı sütununu küçükten büyüğe sırala", logic: "Sort employee birth year column in ascending order", category: "bordro", output: {"action":"sort","direction":"asc","column":"Doğum Yılı","reply":"✅ Çalışan doğum yılı küçükten büyüğe sıralandı.","changes":[]} },
  { user_command: "depo transfer miktarlarının ortalamasını hesapla", logic: "Calculate the average value of warehouse transfer quantities", category: "depo", output: {"action":"average","column":"Depo Transfer Miktarı","reply":"✅ Depo transfer miktarları ortalaması hesaplandı.","changes":[]} },
  { user_command: "müşteri bakiyesi en yüksek 5 kaydı göster", logic: "Show the top 5 records with the highest customer balance", category: "muhasebe", output: {"action":"max","column":"Müşteri Bakiyesi","reply":"✅ Müşteri bakiyesi en yüksek 5 kayıt gösterildi.","changes":[]} },
  { user_command: "satış faturası iptal olanları griye boya", logic: "Highlight rows where sales invoice is cancelled with grey color", category: "satış", output: {"action":"highlight","condition":"equals İptal","color":"#808080","reply":"✅ İptal olan satış faturaları griye boyandı.","changes":[]} },
  { user_command: "stok güvenlik stoğu sütunu ekle", logic: "Add a new column for safety stock level values", category: "stok", output: {"action":"update_cells","formula":"Güvenlik Stoğu sütunu eklendi","reply":"✅ Stok güvenlik stoğu sütunu eklendi.","changes":[]} },
  { user_command: "yeni bir gümrük beyan satırı ekle", logic: "Add a new empty row for customs declaration records", category: "tedarik", output: {"action":"add_row","reply":"➕ Yeni bir gümrük beyan satırı eklendi.","changes":[]} },
  { user_command: "işten çıkış tarihi bu ay olanları filtrele", logic: "Filter rows where employee termination date falls within current month", category: "bordro", output: {"action":"filter","condition":"this_month","column":"İşten Çıkış Tarihi","value":"bu ay","reply":"✅ Bu ay işten çıkan çalışanların kayıtları filtrelendi.","changes":[]} },
  { user_command: "alacak bakiyesi sıfırdan büyük olanları listele", logic: "Filter rows where receivable balance is greater than zero", category: "muhasebe", output: {"action":"filter","condition":"> 0","column":"Alacak Bakiyesi","value":"0","reply":"✅ Alacak bakiyesi sıfırdan büyük kayıtlar listelendi.","changes":[]} },
  { user_command: "depo doluluk oranı sütununun ortalamasını hesapla", logic: "Calculate the average warehouse occupancy rate across all rows", category: "depo", output: {"action":"average","column":"Depo Doluluk Oranı","reply":"✅ Depo doluluk oranı ortalaması hesaplandı.","changes":[]} },
  { user_command: "e-fatura düzenleme tarihi en eskiden en yeniye sırala", logic: "Sort e-invoice issue date column in ascending order", category: "e-fatura", output: {"action":"sort","direction":"asc","column":"E-Fatura Düzenleme Tarihi","reply":"✅ E-fatura düzenleme tarihi en eskiden en yeniye sıralandı.","changes":[]} },
  { user_command: "prim oranı en yüksek çalışanı bul", logic: "Find the employee with the maximum bonus rate", category: "bordro", output: {"action":"max","column":"Prim Oranı","reply":"✅ Prim oranı en yüksek çalışan bulundu.","changes":[]} },
  { user_command: "satış bölgesi ege olanları yeşile boya", logic: "Highlight rows where sales region equals Aegean with green color", category: "satış", output: {"action":"highlight","condition":"equals Ege","color":"#00FF00","reply":"✅ Satış bölgesi Ege olan satırlar yeşile boyandı.","changes":[]} },
  { user_command: "stok lot numarası tekrarlananları kaldır", logic: "Remove duplicate rows based on stock lot number column", category: "stok", output: {"action":"remove_duplicates","reply":"✅ Tekrarlanan stok lot numaraları kaldırıldı.","changes":[]} },
  { user_command: "tedarikçi fatura tutarlarının toplamını hesapla", logic: "Calculate the total sum of supplier invoice amounts", category: "tedarik", output: {"action":"sum","column":"Tedarikçi Fatura Tutarı","reply":"✅ Tedarikçi fatura tutarları toplamı hesaplandı.","changes":[]} },
  { user_command: "yeni bir tahsilat makbuzu satırı ekle", logic: "Add a new empty row for collection receipt records", category: "muhasebe", output: {"action":"add_row","reply":"➕ Yeni bir tahsilat makbuzu satırı eklendi.","changes":[]} },
  { user_command: "çalışan sicil numarası sütununu küçükten büyüğe sırala", logic: "Sort employee registration number column in ascending order", category: "bordro", output: {"action":"sort","direction":"asc","column":"Sicil Numarası","reply":"✅ Çalışan sicil numarası küçükten büyüğe sıralandı.","changes":[]} },
  { user_command: "kdv iade tutarı en yüksek faturayı göster", logic: "Find the invoice with the maximum VAT refund amount", category: "e-fatura", output: {"action":"max","column":"KDV İade Tutarı","reply":"✅ KDV iade tutarı en yüksek fatura gösterildi.","changes":[]} },
  { user_command: "depo giriş adedi ile çıkış adedi farkını hesapla", logic: "Calculate the difference between warehouse entry and exit quantities and add as a new column", category: "depo", output: {"action":"update_cells","formula":"=Depo Giriş Adedi - Depo Çıkış Adedi","reply":"✅ Depo giriş ve çıkış adedi farkı hesaplandı.","changes":[]} },
  { user_command: "satış temsilcisi adını büyük harfe çevir", logic: "Transform sales representative name column to uppercase", category: "satış", output: {"action":"transform","transform":"uppercase","reply":"✅ Satış temsilcisi adları büyük harfe çevrildi.","changes":[]} },
  { user_command: "asgari ücretin altındaki maaşları kırmızıya boya", logic: "Highlight rows where salary is below minimum wage threshold with red color", category: "bordro", output: {"action":"highlight","condition":"< asgari ücret","color":"#FF0000","reply":"✅ Asgari ücretin altındaki maaşlar kırmızıya boyandı.","changes":[]} },
