...
// --- GRUP 1: Muhasebe / Türk Vergi Sistemi (25 örnek) ---
  ...
  // ──────────────────────────────────────────────────────────
  { user_command: "kdv hesapla", logic: "calculate VAT 18% on price column", category: "muhasebe", output: {"action":"update_cells","formula":"=B2*1.18","reply":"✅ KDV dahil tutarlar hesaplandı (%18 KDV uygulandı).","changes":[]} },
  { user_command: "kdv tutarını ayrıştır", logic: "extract VAT amount from total price", category: "muhasebe", output: {"action":"update_cells","formula":"=B2/1.18*0.18","reply":"✅ KDV tutarları ayrıştırıldı.","changes":[]} },
  { user_command: "net tutarı bul", logic: "calculate net amount by removing VAT", category: "muhasebe", output: {"action":"update_cells","formula":"=B2/1.18","reply":"✅ KDV hariç net tutarlar hesaplandı.","changes":[]} },
  { user_command: "sgk primlerini topla", logic: "sum SGK premium column", category: "bordro", output: {"action":"sum","column":"SGK Primi","reply":"✅ Toplam SGK primi hesaplandı.","changes":[]} },
  { user_command: "brüt maaşları topla", logic: "sum gross salary column", category: "bordro", output: {"action":"sum","column":"Brüt Maaş","reply":"✅ Tüm brüt maaşların toplamı hesaplandı.","changes":[]} },
  { user_command: "net maaşları topla", logic: "sum net salary column", category: "bordro", output: {"action":"sum","column":"Net Maaş","reply":"✅ Tüm net maaşların toplamı hesaplandı.","changes":[]} },
  { user_command: "gelir vergisi kesintilerini topla", logic: "sum income tax deduction column", category: "bordro", output: {"action":"sum","column":"Gelir Vergisi","reply":"✅ Toplam gelir vergisi kesintileri hesaplandı.","changes":[]} },
  { user_command: "stok değerini hesapla", logic: "calculate total stock value by multiplying quantity and unit price", category: "stok", output: {"action":"update_cells","formula":"=B2*C2","reply":"✅ Stok değerleri hesaplandı (Miktar × Birim Fiyat).","changes":[]} },
  { user_command: "toplam stok değeri ne kadar", logic: "sum total inventory value column", category: "stok", output: {"action":"sum","column":"Stok Değeri","reply":"✅ Toplam stok değeri hesaplandı.","changes":[]} },
  { user_command: "kritik stok altındakileri filtrele", logic: "filter rows where stock quantity is less than minimum stock level", category: "stok", output: {"action":"filter","condition":"less_than","column":"Stok Miktarı","value":"Minimum Stok","reply":"✅ Kritik stok seviyesinin altındaki ürünler filtrelendi.","changes":[]} },
  { user_command: "stokta olmayan ürünleri göster", logic: "filter rows where stock quantity equals zero", category: "stok", output: {"action":"filter","condition":"equals","column":"Stok Miktarı","value":"0","reply":"✅ Stok miktarı sıfır olan ürünler listelendi.","changes":[]} },
  { user_command: "en çok stoku olan ürünü bul", logic: "find maximum value in stock quantity column", category: "stok", output: {"action":"max","column":"Stok Miktarı","reply":"✅ En yüksek stok miktarına sahip ürün bulundu.","changes":[]} },
  { user_command: "ödenmemiş faturaları göster", logic: "filter rows where payment status is unpaid", category: "muhasebe", output: {"action":"filter","condition":"equals","column":"Ödeme Durumu","value":"Ödenmedi","reply":"✅ Ödenmemiş faturalar listelendi.","changes":[]} },
  { user_command: "ödenen faturaları filtrele", logic: "filter rows where payment status is paid", category: "muhasebe", output: {"action":"filter","condition":"equals","column":"Ödeme Durumu","value":"Ödendi","reply":"✅ Ödenmiş faturalar filtrelendi.","changes":[]} },
  { user_command: "bu ayki faturaları göster", logic: "filter invoices by current month", category: "muhasebe", output: {"action":"filter","condition":"equals","column":"Ay","value":"current_month","reply":"✅ Bu aya ait faturalar listelendi.","changes":[]} },
  { user_command: "vadesi geçmiş faturaları listele", logic: "filter rows where due date is before today", category: "muhasebe", output: {"action":"filter","condition":"less_than","column":"Vade Tarihi","value":"TODAY()","reply":"✅ Vadesi geçmiş faturalar listelendi.","changes":[]} },
  { user_command: "toplam borç ne kadar", logic: "sum total debt column", category: "muhasebe", output: {"action":"sum","column":"Borç","reply":"✅ Toplam borç miktarı hesaplandı.","changes":[]} },
  { user_command: "toplam alacak hesapla", logic: "sum total receivables column", category: "muhasebe", output: {"action":"sum","column":"Alacak","reply":"✅ Toplam alacak miktarı hesaplandı.","changes":[]} },
  { user_command: "kâr zarar hesapla", logic: "calculate profit or loss by subtracting expenses from revenue", category: "muhasebe", output: {"action":"update_cells","formula":"=B2-C2","reply":"✅ Kâr/Zarar tutarları hesaplandı (Gelir - Gider).","changes":[]} },
  { user_command: "brüt kârı hesapla", logic: "calculate gross profit by subtracting cost of goods from sales", category: "muhasebe", output: {"action":"update_cells","formula":"=B2-C2","reply":"✅ Brüt kâr değerleri hesaplandı.","changes":[]} },
  { user_command: "kâr marjını yüzde olarak göster", logic: "calculate profit margin percentage", category: "muhasebe", output: {"action":"update_cells","formula":"=(B2-C2)/B2*100","reply":"✅ Kâr marjı yüzdesi hesaplandı.","changes":[]} },
  { user_command: "iskonto uygula", logic: "apply 10% discount to price column", category: "satış", output: {"action":"update_cells","formula":"=B2*0.90","reply":"✅ %10 iskonto uygulandı.","changes":[]} },
  { user_command: "indirimli fiyatları hesapla", logic: "calculate discounted prices from original price and discount rate", category: "satış", output: {"action":"update_cells","formula":"=B2*(1-C2)","reply":"✅ İndirimli fiyatlar hesaplandı.","changes":[]} },
  { user_command: "satış hedefine ulaşamayanları göster", logic: "filter rows where sales are below target", category: "satış", output: {"action":"filter","condition":"less_than","column":"Satış","value":"Hedef","reply":"✅ Satış hedefine ulaşamayan kayıtlar filtrelendi.","changes":[]} },
  { user_command: "hedefi aşanları filtrele", logic: "filter rows where sales exceed target", category: "satış", output: {"action":"filter","condition":"greater_than","column":"Satış","value":"Hedef","reply":"✅ Satış hedefini aşan kayıtlar filtrelendi.","changes":[]} },
  { user_command: "en yüksek satış hangi bölgede", logic: "find maximum sales value by region", category: "satış", output: {"action":"max","column":"Bölge Satışı","reply":"✅ En yüksek satışın yapıldığı bölge bulundu.","changes":[]} },
  { user_command: "aylık satış toplamı", logic: "sum monthly sales totals", category: "satış", output: {"action":"sum","column":"Aylık Satış","reply":"✅ Aylık satış toplamı hesaplandı.","changes":[]} },
  { user_command: "çalışan sayısını göster", logic: "count number of employees", category: "bordro", output: {"action":"count","column":"Çalışan Adı","reply":"✅ Toplam çalışan sayısı hesaplandı.","changes":[]} },
  { user_command: "departmana göre sırala", logic: "sort data by department column alphabetically", category: "bordro", output: {"action":"sort","direction":"asc","column":"Departman","reply":"✅ Veriler departmana göre alfabetik olarak sıralandı.","changes":[]} },
  { user_command: "işe giriş tarihine göre sırala", logic: "sort by hire date ascending", category: "bordro", output: {"action":"sort","direction":"asc","column":"İşe Giriş Tarihi","reply":"✅ Çalışanlar işe giriş tarihine göre sıralandı.","changes":[]} },
  { user_command: "en yüksek maaşlı 3 çalışanı bul", logic: "find top 3 employees with highest salary", category: "bordro", output: {"action":"max","column":"Maaş","reply":"✅ En yüksek maaş alan 3 çalışan listelendi.","changes":[]} },
  { user_command: "izin günlerini topla", logic: "sum total leave days column", category: "bordro", output: {"action":"sum","column":"İzin Günü","reply":"✅ Toplam izin günleri hesaplandı.","changes":[]} },
  { user_command: "fazla mesai ücretlerini hesapla", logic: "calculate overtime pay", category: "bordro", output: {"action":"update_cells","formula":"=B2*C2*1.5","reply":"✅ Fazla mesai ücretleri hesaplandı.","changes":[]} },
  { user_command: "prim ödemelerini topla", logic: "sum bonus payments column", category: "bordro", output: {"action":"sum","column":"Prim","reply":"✅ Toplam prim ödemeleri hesaplandı.","changes":[]} },
  { user_command: "tedarikçi adına göre sırala", logic: "sort by supplier name alphabetically", category: "tedarik", output: {"action":"sort","direction":"asc","column":"Tedarikçi Adı","reply":"✅ Tedarikçiler adına göre alfabetik sıralandı.","changes":[]} },
  { user_command: "en ucuz tedarikçiyi bul", logic: "find minimum unit price by supplier", category: "tedarik", output: {"action":"min","column":"Birim Fiyat","reply":"✅ En düşük fiyat sunan tedarikçi bulundu.","changes":[]} },
  { user_command: "tedarikçi bazında toplam sipariş tutarı", logic: "sum total order amount by supplier", category: "tedarik", output: {"action":"sum","column":"Sipariş Tutarı","reply":"✅ Tedarikçi bazında toplam sipariş tutarları hesaplandı.","changes":[]} },
  { user_command: "teslim süresi ortalaması", logic: "calculate average delivery time", category: "tedarik", output: {"action":"average","column":"Teslim Süresi","reply":"✅ Ortalama teslim süresi hesaplandı.","changes":[]} },
  { user_command: "geciken teslimatları listele", logic: "filter rows where actual delivery date is after expected delivery date", category: "tedarik", output: {"action":"filter","condition":"greater_than","column":"Gerçek Teslim","value":"Planlanan Teslim","reply":"✅ Geciken teslimatlar listelendi.","changes":[]} },
  { user_command: "aktif tedarikçileri filtrele", logic: "filter rows where supplier status is active", category: "tedarik", output: {"action":"filter","condition":"equals","column":"Durum","value":"Aktif","reply":"✅ Aktif tedarikçiler filtrelendi.","changes":[]} },
  { user_command: "depo lokasyonuna göre sırala", logic: "sort by warehouse location alphabetically", category: "depo", output: {"action":"sort","direction":"asc","column":"Depo Lokasyonu","reply":"✅ Veriler depo lokasyonuna göre sıralandı.","changes":[]} },
  { user_command: "raf ömrü dolan ürünleri göster", logic: "filter rows where expiry date is before today", category: "depo", output: {"action":"filter","condition":"less_than","column":"Son Kullanma Tarihi","value":"TODAY()","reply":"✅ Raf ömrü dolmuş ürünler listelendi.","changes":[]} },
  { user_command: "depo doluluk oranını hesapla", logic: "calculate warehouse occupancy rate", category: "depo", output: {"action":"update_cells","formula":"=B2/C2*100","reply":"✅ Depo doluluk oranları hesaplandı.","changes":[]} },
  { user_command: "e-fatura olanları filtrele", logic: "filter rows where invoice type is e-invoice", category: "muhasebe", output: {"action":"filter","condition":"equals","column":"Fatura Tipi","value":"E-Fatura","reply":"✅ E-fatura kayıtları filtrelendi.","changes":[]} },
  { user_command: "e-arşiv faturaları listele", logic: "filter rows where invoice type is e-archive", category: "muhasebe", output: {"action":"filter","condition":"equals","column":"Fatura Tipi","value":"E-Arşiv","reply":"✅ E-arşiv faturaları listelendi.","changes":[]} },
  { user_command: "fatura numarasına göre sırala", logic: "sort by invoice number ascending", category: "muhasebe", output: {"action":"sort","direction":"asc","column":"Fatura No","reply":"✅ Faturalar numarasına göre küçükten büyüğe sıralandı.","changes":[]} },
  { user_command: "ürün kategorisine göre sırala", logic: "sort by product category alphabetically", category: "stok", output: {"action":"sort","direction":"asc","column":"Kategori","reply":"✅ Ürünler kategoriye göre alfabetik sıralandı.","changes":[]} },
  { user_command: "kategori bazında satış toplamı", logic: "sum sales by product category", category: "satış", output: {"action":"sum","column":"Kategori Satışı","reply":"✅ Kategori bazında satış toplamları hesaplandı.","changes":[]} },
  { user_command: "büyük harfe çevir", logic: "convert text in column to uppercase", category: "veri", output: {"action":"transform","transform":"uppercase","reply":"✅ Metinler büyük harfe dönüştürüldü.","changes":[]} },
  { user_command: "küçük harfe çevir", logic: "convert text in column to lowercase", category: "veri", output: {"action":"transform","transform":"lowercase","reply":"✅ Metinler küçük harfe dönüştürüldü.","changes":[]} },
  { user_command: "baş harfleri büyüt", logic: "convert text to proper case with first letters capitalized", category: "veri", output: {"action":"transform","transform":"propercase","reply":"✅ Metinlerin baş harfleri büyütüldü.","changes":[]} },
  { user_command: "boşlukları temizle", logic: "trim leading and trailing spaces from text cells", category: "veri", output: {"action":"transform","transform":"trim","reply":"✅ Hücrelerdeki gereksiz boşluklar temizlendi.","changes":[]} },
  { user_command: "yeni satır ekle", logic: "add a new empty row at the end of data", category: "veri", output: {"action":"add_row","reply":"➕ Yeni bir boş satır eklendi.","changes":[]} },
  { user_command: "filtreyi kaldır", logic: "remove all active filters from dataset", category: "filtre", output: {"action":"remove_filter","reply":"✅ Tüm filtreler kaldırıldı, tüm veriler gösteriliyor.","changes":[]} },
  { user_command: "tüm filtreleri temizle", logic: "clear all filters applied to the spreadsheet", category: "filtre", output: {"action":"remove_filter","reply":"✅ Filtreler temizlendi.","changes":[]} },
  { user_command: "500 üzeri satışları göster", logic: "filter rows where sales value is greater than 500", category: "satış", output: {"action":"filter","condition":"greater_than","column":"Satış","value":"500","reply":"✅ 500 üzerindeki satış kayıtları filtrelendi.","changes":[]} },
  { user_command: "1000 altı tutarları filtrele", logic: "filter rows where amount is less than 1000", category: "muhasebe", output: {"action":"filter","condition":"less_than","column":"Tutar","value":"1000","reply":"✅ 1000'in altındaki tutarlar filtrelendi.","changes":[]} },
  { user_command: "ankara şubesini göster", logic: "filter rows where branch is Ankara", category: "satış", output: {"action":"filter","condition":"equals","column":"Şube","value":"Ankara","reply":"✅ Ankara şubesine ait kayıtlar filtrelendi.","changes":[]} },
  { user_command: "izmir müşterilerini listele", logic: "filter rows where city is Izmir", category: "satış", output: {"action":"filter","condition":"equals","column":"Şehir","value":"İzmir","reply":"✅ İzmir'deki müşteri kayıtları listelendi.","changes":[]} },
  { user_command: "ocak ayı verilerini göster", logic: "filter rows where month is January", category: "muhasebe", output: {"action":"filter","condition":"equals","column":"Ay","value":"Ocak","reply":"✅ Ocak ayına ait veriler filtrelendi.","changes":[]} },
  { user_command: "2024 yılı kayıtlarını filtrele", logic: "filter rows where year is 2024", category: "muhasebe", output: {"action":"filter","condition":"equals","column":"Yıl","value":"2024","reply":"✅ 2024 yılına ait kayıtlar filtrelendi.","changes":[]} },
  { user_command: "onaylanan siparişleri listele", logic: "filter rows where order status is approved", category: "satış", output: {"action":"filter","condition":"equals","column":"Durum","value":"Onaylandı","reply":"✅ Onaylanan siparişler listelendi.","changes":[]} },
  { user_command: "beklemedeki siparişleri göster", logic: "filter rows where order status is pending", category: "satış", output: {"action":"filter","condition":"equals","column":"Durum","value":"Beklemede","reply":"✅ Beklemedeki siparişler filtrelendi.","changes":[]} },
  { user_command: "iade edilen ürünleri listele", logic: "filter rows where return status is returned", category: "satış", output: {"action":"filter","condition":"equals","column":"İade Durumu","value":"İade Edildi","reply":"✅ İade edilen ürünler listelendi.","changes":[]} },
  { user_command: "kargo bekleyenleri filtrele", logic: "filter rows where shipment status is awaiting shipment", category: "depo", output: {"action":"filter","condition":"equals","column":"Kargo Durumu","value":"Kargoda","reply":"✅ Kargo bekleyen siparişler filtrelendi.","changes":[]} },
  { user_command: "teslim edilenleri göster", logic: "filter rows where delivery status is delivered", category: "depo", output: {"action":"filter","condition":"equals","column":"Teslimat Durumu","value":"Teslim Edildi","reply":"✅ Teslim edilen siparişler listelendi.","changes":[]} },
  { user_command: "kdv oranına göre sırala", logic: "sort by VAT rate column ascending", category: "muhasebe", output: {"action":"sort","direction":"asc","column":"KDV Oranı","reply":"✅ Veriler KDV oranına göre küçükten büyüğe sıralandı.","changes":[]} },
  { user_command: "vergi numarasına göre sırala", logic: "sort by tax number column ascending", category: "muhasebe", output: {"action":"sort","direction":"asc","column":"Vergi No","reply":"✅ Kayıtlar vergi numarasına göre sıralandı.","changes":[]} },
  { user_command: "müşteri segmentine göre sırala", logic: "sort by customer segment alphabetically", category: "satış", output: {"action":"sort","direction":"asc","column":"Segment","reply":"✅ Müşteriler segmentlerine göre alfabetik sıralandı.","changes":[]} },
  { user_command: "toplam gider nedir", logic: "sum total expenses column", category: "muhasebe", output: {"action":"sum","column":"Gider","reply":"✅ Toplam gider tutarı hesaplandı.","changes":[]} },
  { user_command: "toplam gelir ne kadar", logic: "sum total revenue column", category: "muhasebe", output: {"action":"sum","column":"Gelir","reply":"✅ Toplam gelir tutarı hesaplandı.","changes":[]} },
  { user_command: "ortalama sipariş değeri ne", logic: "calculate average order value", category: "satış", output: {"action":"average","column":"Sipariş Tutarı","reply":"✅ Ortalama sipariş değeri hesaplandı.","changes":[]} },
  { user_command: "ortalama teslimat süresi kaç gün", logic: "calculate average delivery days", category: "tedarik", output: {"action":"average","column":"Teslimat Günü","reply":"✅ Ortalama teslimat süresi gün olarak hesaplandı.","changes":[]} },
  { user_command: "minimum sipariş miktarı ne", logic: "find minimum order quantity", category: "tedarik", output: {"action":"min","column":"Sipariş Miktarı","reply":"✅ En düşük sipariş miktarı bulundu.","changes":[]} },
  { user_command: "maksimum stok seviyesi ne", logic: "find maximum stock level", category: "stok", output: {"action":"max","column":"Stok Seviyesi","reply":"✅ En yüksek stok seviyesi bulundu.","changes":[]} },
  { user_command: "toplam iade tutarı", logic: "sum total return amount column", category: "satış", output: {"action":"sum","column":"İade Tutarı","reply":"✅ Toplam iade tutarı hesaplandı.","changes":[]} },
  { user_command: "zarar eden satırları kırmızıya boya", logic: "highlight rows with negative profit in red", category: "görsel", output: {"action":"highlight","condition":"less_than_zero","color":"#FF0000","reply":"✅ Zarar eden satırlar kırmızıya boyandı.","changes":[]} },
  { user_command: "hedefi tutturanları yeşile boya", logic: "highlight rows where sales met or exceeded target in green", category: "görsel", output: {"action":"highlight","condition":"greater_than_or_equal_target","color":"#00FF00","reply":"✅ Hedefi tutturan satırlar yeşile boyandı.","changes":[]} },
  { user_command: "vadesi bugün olanlari sarıya boya", logic: "highlight rows where due date equals today in yellow", category: "görsel", output: {"action":"highlight","condition":"equals_today","color":"#FFFF00","reply":"✅ Vadesi bugün olan satırlar sarıya boyandı.","changes":[]} },
  { user_command: "kritik stoktaki ürünleri turuncu yap", logic: "highlight rows with stock below critical level in orange", category: "görsel", output: {"action":"highlight","condition":"below_critical_stock","color":"#FFA500","reply":"✅ Kritik stok altındaki ürünler turuncu yapıldı.","changes":[]} },
  { user_command: "en düşük 5 değeri mavi yap", logic: "highlight bottom 5 values in blue", category: "görsel", output: {"action":"highlight","condition":"bottom_5","color":"#0000FF","reply":"✅ En düşük 5 değer mavi renkte işaretlendi.","changes":[]} },
  { user_command: "negatif bakiyeleri vurgula", logic: "highlight cells with negative balance values", category: "muhasebe", output: {"action":"highlight","condition":"less_than_zero","color":"#FF0000","reply":"✅ Negatif bakiyeli satırlar vurgulandı.","changes":[]} },
  { user_command: "yüzde 20 kdv uygula", logic: "calculate 20% VAT on price column", category: "muhasebe", output: {"action":"update_cells","formula":"=B2*1.20","reply":"✅ %20 KDV dahil tutarlar hesaplandı.","changes":[]} },
  { user_command: "kdv 20 olan faturaları listele", logic: "filter rows where VAT rate is 20%", category: "muhasebe", output: {"action":"filter","condition":"equals","column":"KDV Oranı","value":"20","reply":"✅ %20 KDV oranına sahip faturalar listelendi.","changes":[]} },
  { user_command: "stopaj kesintilerini hesapla", logic: "calculate withholding tax deductions", category: "muhasebe", output: {"action":"update_cells","formula":"=B2*0.20","reply":"✅ Stopaj kesintileri hesaplandı (%20).","changes":[]} },
  { user_command: "amortisman tutarlarını topla", logic: "sum depreciation amounts column", category: "muhasebe", output: {"action":"sum","column":"Amortisman","reply":"✅ Toplam amortisman tutarları hesaplandı.","changes":[]} },
  { user_command: "aktif çalışanları filtrele", logic: "filter rows where employee status is active", category: "bordro", output: {"action":"filter","condition":"equals","column":"Çalışan Durumu","value":"Aktif","reply":"✅ Aktif çalışanlar filtrelendi.","changes":[]} },
  { user_command: "işten ayrılanları listele", logic: "filter rows where employee status is terminated", category: "bordro", output: {"action":"filter","condition":"equals","column":"Çalışan Durumu","value":"Ayrıldı","reply":"✅ İşten ayrılan çalışanlar listelendi.","changes":[]} },
  { user_command: "tam zamanlı çalışanları göster", logic: "filter rows where employment type is full-time", category: "bordro", output: {"action":"filter","condition":"equals","column":"Çalışma Tipi","value":"Tam Zamanlı","reply":"✅ Tam zamanlı çalışanlar filtrelendi.","changes":[]} },
  { user_command: "part time çalışanları filtrele", logic: "filter rows where employment type is part-time", category: "bordro", output: {"action":"filter","condition":"equals","column":"Çalışma Tipi","value":"Part-Time","reply":"✅ Part-time çalışanlar filtrelendi.","changes":[]} },
  { user_command: "toplam üretim miktarını bul", logic: "sum total production quantity column", category: "depo", output: {"action":"sum","column":"Üretim Miktarı","reply":"✅ Toplam üretim miktarı hesaplandı.","changes":[]} },
  { user_command: "fire oranını hesapla", logic: "calculate waste rate as percentage of production", category: "depo", output: {"action":"update_cells","formula":"=B2/C2*100","reply":"✅ Fire oranları yüzde olarak hesaplandı.","changes":[]} },
  { user_command: "hangi ürün en çok iade edildi", logic: "find maximum return quantity by product", category: "satış", output: {"action":"max","column":"İade Miktarı","reply":"✅ En çok iade edilen ürün bulundu.","changes":[]} },
  { user_command: "müşteri bazında toplam harcama", logic: "sum total spending by customer", category: "satış", output: {"action":"sum","column":"Harcama","reply":"✅ Müşteri bazında toplam harcamalar hesaplandı.","changes":[]} },
  { user_command: "verisi eksik olanları göster", logic: "filter rows with empty or missing values", category: "veri", output: {"action":"filter","condition":"is_empty","column":"Veri","value":"","reply":"✅ Eksik verisi olan satırlar listelendi.","changes":[]} },
  { user_command: "telefon numarası olmayanları listele", logic: "filter rows where phone number is empty", category: "veri", output: {"action":"filter","condition":"is_empty","column":"Telefon","value":"","reply":"✅ Telefon numarası girilmemiş kayıtlar listelendi.","changes":[]} },
  { user_command: "e-posta adresi eksik olanları göster", logic: "filter rows where email address is empty", category: "veri", output: {"action":"filter","condition":"is_empty","column":"E-Posta","value":"","reply":"✅ E-posta adresi girilmemiş kayıtlar gösterildi.","changes":[]} },
